...
class Data extends \Magento\Framework\App\Helper\AbstractHelper{
    ...
    public function getFirstLineTextPrice()
    {
        return $this->scopeConfig->getValue('goldblocking/general/first_line_text', \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE);

    }

    public function getSecondLineTextPrice()
    {
        return $this->scopeConfig->getValue('goldblocking/general/second_line_text', \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE);

    }

    public function getThirdLineTextPrice()
    {
        return $this->scopeConfig->getValue('goldblocking/general/third_line_text', \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE);

    }

    public function getDieCreationPrice()
    {
        return $this->scopeConfig->getValue('goldblocking/general/die_creation_price', \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE);

    }

    public function getDieImprintPrice()
    {
        return $this->scopeConfig->getValue('goldblocking/general/die_imprint_price', \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE);

    }



    public function getInstrumentNamePrice()
    {
        return $this->scopeConfig->getValue('goldblocking/general/instrument_name_or_number', \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE);
