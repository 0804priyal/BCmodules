...
class RelatedProductTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetRelatedProductIds()
    {
        ...
        $postMock->expects($this->exactly(2))
    ...
    /**
     * Testing of getRelatedProductIds method when no related products are set
     */
    public function testGetRelatedProductIdsNull()
    {
        $relatedProductsLimit = 3;
        ...
        $this->assertEquals($expectedArraySize, count($this->block->getRelatedProductIds()));
    }
