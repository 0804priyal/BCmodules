...
class RelatedProduct extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $relatedProductIds = is_array($this->getPost()->getRelatedProductIds())
            ? $this->getPost()->getRelatedProductIds()
            : [];
        return array_slice($relatedProductIds, 0, $this->config->getRelatedProductsLimit());
    }
